//test
import { switchWord, replaceCharacter, sillyReplace, sillyMoveCharCode, totallyRandom } from "@/containers/newsAndMedia/BreakingNews/text/textTesting";
...
const POS_META_DATA = [
  ...
  },
  {
    ...
    textEditFunction: (text, keyword) => text.replaceAll("z", "%").replaceAll("it", "FAANG"),
  },
  {
    idx: 4,
    top: (news, i, j, size) => (Math.abs(j - i) / 2) * (size.windowWidth < 768 ? 80 : 60) + (news.asset_id % 13) * 10,
    ...
    titleSize: (news, i, j, size) => 1.5 + (size.windowWidth % (j + i)) * 0.03,
    textEditFunction: (text, keyword) => switchWord(text, 3).replaceAll(".", "Harry Potter"),
  },

  {
    ...
    textEditFunction: (text, keyword) => switchWord(text, 10).replaceAll(",", "@"),
  },
  {
    idx: 6,
    top: (news, i, j, size) => size.windowHeight * 0.5 + getRandom(0, 0.8) * size.windowHeight * Math.cos(getRandom(0, Math.PI * 2)),
    left: (news, i, j, size) => size.windowWidth * 0.2 + getRandom(0, 0.5) * size.windowWidth * Math.sin(getRandom(0, Math.PI * 2)),
    titleSize: (news, i, j, size) => (Math.abs(j + i / 5) ** 2 / 140) ** 3 * 2,
    textEditFunction: (text, keyword) => switchWord(text, 20).replaceAll(".", "%").replaceAll(",", "@"),
  },
  {
    idx: 7,
    ...
    textEditFunction: (text, keyword) => switchWord(text, 20).replaceAll("s", "$").replaceAll(".", "!").replace(",", "?"),
  },
  {
    idx: 8,
    top: (news, i, j, size) => (((news.asset_id + j * 5) % 314) / 314) * size.windowHeight,
    left: (news, i, j, size) => (((news.asset_id + j * 73) % 373) / 373) * size.windowWidth,
    opacity: (news, i, j, size) => getRandom(0, 0.3),
    titleSize: (news, i, j, size) => (Math.abs(j - i / 2) > 8 ? getRandom(5, 10) : getRandom(1, 2)),
    abstractSize: (news, i, j, size) => (Math.abs(j + i / 2) > 18 ? getRandom(5, 10) : getRandom(0, 3)),
    textEditFunction: (text, keyword) => switchWord(text, 20).replaceAll("s", "$").replaceAll(".", "!").replace(",", "?"),
  },
  {
    idx: 9,
  ...
  },
  {
    ...
    textEditFunction: (text, keyword) => sillyMoveCharCode(text),
  },
  {
    idx: 11,
    top: (news, i, j, size) => getRandom(-2 * size.windowHeight, size.windowHeight),
    left: (news, i, j, size) => getRandom(-2.5 * size.windowWidth, size.windowWidth),
    opacity: (news, i, j, size) => 0.1 + j * 0.01,
    titleSize: (news, i, j, size) => 1 + (10 - j) ** 2,
    abstractSize: (news, i, j, size) => getRandom(3, getRandom(50, 100)),
  ...
  },
  {
    ...
    titleSize: (news, i, j, size) => 1 + (10 - j) ** 2,
    abstractSize: (news, i, j, size) => getRandom(3, getRandom(50, 100)),
    textEditFunction: (text, keyword) => totallyRandom(text),
  },
  {
    idx: 14,
    top: (news, i, j, size) => getRandom(-1 * size.windowHeight, size.windowHeight),
  ...
  },
  {
    ...
    titleSize: (news, i, j, size) => (Math.abs(j - i / 2) > 8 ? getRandom(10, 40) : getRandom(1, 2)),
    abstractSize: (news, i, j, size) => (Math.abs(j + i / 2) > 18 ? getRandom(5, 100) : getRandom(0, 3)),
    textEditFunction: (text, keyword) => totallyRandom(text, 0.03, 0.15),
  },
  {
    idx: 16,
    top: (news, i, j, size) => (((news.asset_id + j * 5) % 314) / 314) * size.windowHeight,
    ...
    titleSize: (news, i, j, size) => (Math.abs(j - i / 2) > 8 ? getRandom(5, 10) : getRandom(1, 2)),
    abstractSize: (news, i, j, size) => (Math.abs(j + i / 2) > 18 ? getRandom(5, 10) : getRandom(0, 3)),
    textEditFunction: (text, keyword) => totallyRandom(text, 0.2, 0.15),
  },
  {
    idx: 17,
    top: (news, i, j, size) => ((news.asset_id % 197) / 197) * size.windowHeight,
    left: (news, i, j, size) => (((news.asset_id + j * 73) % 373) / 373) * size.windowWidth,
    titleSize: (news, i, j, size) => (Math.abs(j - i / 5) ** 3 / 400) ** 3 * 2,
    textEditFunction: (text, keyword) => totallyRandom(text, 0.4, 0.15),
  },

  {
    ...
    left: (news, i, j, size) => size.windowWidth * 0.2 + getRandom(0, 0.5) * size.windowWidth * Math.sin(getRandom(0, Math.PI * 2)),
    titleSize: (news, i, j, size) => (Math.abs(j + i / 5) ** 2 / 140) ** 3 * 2,
    textEditFunction: (text, keyword) => totallyRandom(text, 0.5, 0.0),
  },
  {
    idx: 19,
    top: (news, i, j, size) => (Math.abs(date(news) % ((news.asset_id % (i + 10)) + j)) * 0.1 + ((j * i) % 30) / 150 + ((j - i) % 31) / 101) * size.windowHeight,
    ...
    titleSize: (news, i, j, size) => Math.abs(((j - i) * (j + i)) % 10) / 10 + 1.5,
    abstractSize: (news, i, j, size) => 1,
    textEditFunction: (text, keyword) => totallyRandom(text, 0.3, 0.2),
  },
  {
    idx: 20,
    top: (news, i, j, size) => (Math.abs(j - i) / 2) * (size.windowWidth < 768 ? 80 : 60) + (news.asset_id % 13) * 10,
    ...
    opacity: (news, i, j, size) => getRandom(0, getRandom(0, 1)),
    titleSize: (news, i, j, size) => 1.5 + (size.windowWidth % (j + i)) * 0.03,
    textEditFunction: (text, keyword) => totallyRandom(text, 0.3, 0.6),
  },
  {
    idx: 21,
    top: (news, i, j, size) => (Math.abs(j - i) / 2) * (size.windowWidth < 768 ? 80 : 60) + (news.asset_id % 13) * 10,
    ...
    opacity: (news, i, j, size) => 0.3,
    titleSize: (news, i, j, size) => 1.5 + (size.windowWidth % (j + i)) * 0.03,
    textEditFunction: (text, keyword) => totallyRandom(text, 0.1, 0.8),
  },
  {
    idx: 22,
    top: (news, i, j, size) => ((j + i) / 2) * (size.windowWidth < 768 ? 80 : 60) + 10,
    left: (news, i, j, size) => 10 + ((j * news.asset_id) % (i + 10)) * (((i * 2) % 13) + 2) + parseInt(updated_time(news)[0]),
    textEditFunction: (text, keyword) => totallyRandom(text, 0.7, 0.4),
  },
  {
    idx: 23,
    top: (news, i, j, size) => i * (size.windowWidth < 768 ? 80 : 60) + 10,
    left: (news, i, j, size) => 10 + ((j * news.asset_id) % (i + 10)) * (((i * 2) % 13) + 2) + parseInt(updated_time(news)[0]),
    textEditFunction: (text, keyword) => totallyRandom(text, 0.2, 0.4),
  },
];
